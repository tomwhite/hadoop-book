...
public class NewMaxTemperatureWithMultipleInputFormats extends Configured
  implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    MultipleInputs.addInputPath(job, ncdcInputPath,
        TextInputFormat.class, NewMaxTemperatureMapper.class);
  ...
  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(new NewMaxTemperatureWithMultipleInputFormats(),
        args);
