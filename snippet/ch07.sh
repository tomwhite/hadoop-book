...
function TEST_ch07_minimal_map_reduce {
...
function TEST_ch07_minimal_map_reduce_with_defaults {
  source ch07/src/main/examples/MinimalMapReduceWithDefaults.input.txt || return 1
  diff output/part-00000 snippet/expected/ch07/sh/part-00000 || return 1
}

function TEST_ch07_new_minimal_map_reduce {
...
function TEST_ch07_new_minimal_map_reduce_with_defaults {
