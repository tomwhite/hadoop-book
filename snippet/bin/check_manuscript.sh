...
# Should add remaining chapters: ch16-pig ch17-hive
for ch in ch02-mr-intro ch03-hdfs ch05-io ch08-mr-dev ch10-mr-types ch11-mr-features ch17-hive ch21-zk
do
